...
Global $pozycjaX = $tablica_stringow[2]
Global $pozycjaY = $tablica_stringow[3]
Global $port_com = $tablica_stringow[4]
Global $id_wagi = $tablica_stringow[5]
if($CmdLine[0]>6) Then Global $rodzaj_wagi = $tablica_stringow[6]
if($CmdLine[0]>7) Then Global $rodzaj_wagi = $tablica_stringow[6]
if($CmdLine[0]>8) Then Global $rodzaj_wagi = $tablica_stringow[6]
